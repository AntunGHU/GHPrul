...
# Gill zeli demoati kreiranje pullreqa za branch, dodavanje jos pokojeg kommita i commentsa, exploranje fajlova u pullrequ te konacno merganje i brisanje brancha.
...
# Gill cancela review i ide nazad u Conversation tab i tamo naglasava dio kojim GH  izvjestava o mogucnostima Automatskog merganja i daje na raspolaganje i upotrebu gumb "Merge pull request". Klikamo ga sto nam daje mogucnost kreiranja tzv merge-commit-a i "Confirm merge". Klikamo i pojavljuje se izvjestaj merganja i ponuda mogucnosti brisanja mergane grane. Deletamo!!!

# Odlazimo na tab "Pull req" repoa i vidimo da tamo nema vise otvorenih pullreqova ali zapis o otvaranom pull requ je ostao i ako hocu mogu restaurirati i obrisanu granu!
