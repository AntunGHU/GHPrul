...
# Ako se slazemo s prijedlozima kliknemo na "Merge pull req" kad ce PRQ biti inkorporiran u nas main, a ako ne onda unosimo koment i bouncamo back!

# Bouncani back koment stize i emailom na adresu evicae sa sadrzajem komentara kada evica ide u svoj gh i radi dalje na kodu! Nakon dorade jos jedan commit i zaista se to vidi u otvorenom PRQ-u kod AntunGHU.

# Konacno zadovoljan AntunGHU merga! klikom na "Merge pull req" pa "Confirm merge" i merganje se odradjuje a Evica prima mail od AntunGHU o merganju njenog PRQ-a
