...
# odgovaramo na par pitanja: 1. gdje savati key (ajmo ga savati u nadmapu projekta "/home/antun/aCod/vGitVsc") 2.unijeti passfraze(ostavljam prazno); U komandi je veliko -C jer sa malim sam dobijao "Too many arguments."
# key-si su se kreirali u mapi "aCod" a dobili su ime mog zadnjeg unosa u path kad sam odgovarao na lokaciju sa "/home/antun/aCod/vGitVsc" #* !!!NOVO!!!
# otvaramo pub.key, Kopiramo pub-key i idemo na GH -dashboard, profile i Settings i SSH pa klik na "NewSSH keys" i unosimo svoj ssh-pub-key te add-amo! Pokazuje se key i upozorenje da obrisem bilo koji koji ne prepoznajem!
